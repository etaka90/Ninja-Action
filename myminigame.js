...
function inicialize() {
    ...
    assetsToLoader = ["tranquility.json", "running.json", "vertushka.json", "sitting.json", "somersault.json", "rise.json", "drop_down.json","blow.json"];
...
function onAssetsLoaded() {
    ...
    //удар рукой
    for (var i = 0; i < 15; i++) {
        player.animations.blow.texture.push(PIXI.Texture.fromFrame("blow" + i + ".png"));
    }
